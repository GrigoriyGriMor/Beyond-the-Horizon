...
public class ChatSystem : MonoBehaviour
{
    ...
    [SerializeField] private string chatServerAdress = "ws://regserver.cloudsgoods.com:8088/chat";
    ...
    public async void Init(string playerName, int _id, string _session) {
        ...
        chatServerAdress = $"ws://regserver.cloudsgoods.com:8088/chat?id={_id}&session={_session}";
