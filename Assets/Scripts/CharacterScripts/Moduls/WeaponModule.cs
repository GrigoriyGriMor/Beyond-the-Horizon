...
public class WeaponModule : CharacterBase
{
    ...
    void Start()
    {
        ...
        if (weapon[0].ItemInfo != null) {
            weapon_1.sprite = weapon[0].ItemInfo.GetItemIcon_2x1();
            weaponName_1.text = weapon[0].ItemInfo.GetItemName();
            weapon[0].weaponGameObject.GetComponent<WeaponController>().SetBulletCountText(bulletCount_1);
        }
        else
            weapon_1.sprite = defaultWeaponImage;

        if (weapon[1].ItemInfo != null) {
            weapon_2.sprite = weapon[1].ItemInfo.GetItemIcon_2x1();
            ...
            weapon_2.sprite = defaultWeaponImage;
        ...
        if (_weapon == null) {
            switch (wNumber) {
                case 0:
                    ...
                    weapon_1.sprite = defaultWeaponImage;
                    weaponName_1.text = "";
                    weapon_1_panel.color = defaultPanelColor;
                    bulletCount_1.text = "";
                ...
                case 1:
                    ...
                    weapon_2.sprite = defaultWeaponImage;
                    weaponName_2.text = "";
                    weapon_2_panel.color = defaultPanelColor;
                    bulletCount_2.text = "";
    ...
    public IEnumerator GetNextWeapon() {
        ...
        if (weapon_1 != null && weapon_2 != null)
            if (gunInHandNumber == 0)
                weapon_1_panel.color = usingPanelColor;
            else
                weapon_2_panel.color = usingPanelColor;
